...
then
    ...
    then
         ...
         then
             ...
             sudo mv /ephemeral/datamover/nextseq/$RUNNAME /archive/Sequencing/$BSP || Error_Move
             ...
             sudo mv /ephemeral/datamover/nextseq/$RUNNAME /archive/Sequencing/Datamover_withoutBSP || Error_Move
